      ...
      <div className="w-full mx-auto max-w-screen-xl p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <a href="#" className="flex items-center mb-4 sm:mb-0">
            <svg className="h-10 w-10 text-blue-700" viewBox="0 0 52 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">JournalX</span>
          </a>
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2024 <a href="#" className="hover:underline">JournalX™</a>. All Rights Reserved.
        </span>
      </div>
    </footer>
  );
